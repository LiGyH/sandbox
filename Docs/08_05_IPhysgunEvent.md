# 08.05 — Компонент: Событие физ-пушки (IPhysgunEvent) 🔫
...
Фаза завершена. Переходи к **[09.01 — 🛠️ ToolMode.cs — Базовый абстрактный класс режима инструмента](09_01_ToolMode.md)** — начало следующей фазы.
