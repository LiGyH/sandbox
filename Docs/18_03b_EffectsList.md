# 18.03b — Effects UI: EffectsList (список эффектов)
...
Создаём список всех доступных эффектов для вкладки «Effects»: с вкладками «Installed» и «Workshop», чекбоксами включения, предпросмотром при наведении и системой пресетов.

> Это вторая из трёх частей урока 18.03. Предыдущая: [18.03a — EffectsHost](18_03a_EffectsHost.md). Следующая: [18.03c — EffectsProperties](18_03c_EffectsProperties.md).

## Код EffectsList.razor
...
Переходи к **[18.03c — EffectsUI: EffectsProperties](18_03c_EffectsProperties.md)**.
