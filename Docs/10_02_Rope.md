...
Создаём файл `RopeTool.cs` — инструмент, который **соединяет два объекта верёвкой**. Верёвка может быть гибкой (провисающей) или жёсткой, с настраиваемой длиной и толщиной.
